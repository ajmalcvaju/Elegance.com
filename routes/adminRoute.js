...
router.get("/block-user",middleware.loggedIn, adminUserPanel.blockUser);
router.get("/unblock-user",middleware.loggedIn, adminUserPanel.unBlockUser);
...
router.get("/delete-product",middleware.loggedIn, adminProductPanel.deleteUser);
router.get("/restore-product",middleware.loggedIn, adminProductPanel.restoreUser);
router.get("/delete-category",middleware.loggedIn, adminCategoryPanel.deleteCategory);
router.get("/restore-category",middleware.loggedIn, adminCategoryPanel.restoreCategory);
